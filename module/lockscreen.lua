...
local locker = function(s)
	...
	local intruder_capture = function()
		local capture_image =
			[[
		save_dir="]] ..
			locker_config.face_capture_dir ..
				[["
...
local filter_bg_image = function(wall_name, index, ap, width, height)
	...
	convert -quality 100 -brightness-contrast -20x0 ]] ..
						" " ..
							blur_filter_param ..
								" " ..
									locker_config.bg_dir ..
										wall_name ..
											[[ -gravity center -crop ]] ..
												ap ..
													[[:1 +repage -resize ]] ..
														width .. "x" .. height .. [[! ]] .. locker_config.tmp_wall_dir .. index .. wall_name .. [[
	"]]
	return magic
end
