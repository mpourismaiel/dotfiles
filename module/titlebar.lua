...
local create_vertical_bar_filemanager = function(c, pos, bg, size)
	...
	awful.titlebar(c, {position = pos, bg = bg, size = size + 100}):setup {
		wibox.containier.constraint(
			wibox.widget {
				{
					{
...
client.connect_signal(
	...
	function(c)
		...
		if c.type == "normal" then
			if c.class == "kitty" or c.class == "TelegramDesktop" or c.class == "Google-chrome" then
				create_vertical_bar(c, "left", "#00000099", beautiful.titlebar_size)
			elseif c.class == "XTerm" or c.class == "UXTerm" then
				create_horizontal_bar(c, "top", beautiful.xresources.get_current_theme().background, beautiful.titlebar_size)
			elseif c.class == "Thunar" or c.class == "dolphin" then
				create_vertical_bar(c, "left", "#00000099", beautiful.titlebar_size)
