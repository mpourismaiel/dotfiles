...
local monitor_control_row_progressbars =
	...
	layout = wibox.layout.fixed.vertical,
	spacing = dpi(10),
	format_item(require("widget.cpu-meter")),
	format_item(require("widget.ram-meter")),
	format_item(require("widget.temperature-meter")),
	format_item(require("widget.harddrive-meter"))
}
