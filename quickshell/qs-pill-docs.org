...
Item {
    ...
    // keyboard nav (MenuKbNav): Enter flips the switch like a click
...
Item {
    ...
    Item {                                  // back chevron + title (left) — clickable together
        id: backArea
        // keyboard nav (MenuKbNav): the back button is every menu's default focus
        readonly property bool kbFocusable: true
...
- *Hover overrides focus*: a =HoverHandler= hit-tests the focusable list on every
  pointer move, so whatever the mouse touches becomes the keyboard focus.

Focus is drawn as an accent *ring* (border-only rounded rectangle) around the
focused item, re-mapped a few times a second (=tick=) so it tracks scrolling
Flickables; moving focus also auto-scrolls the item into view (=ensureVisible=
walks up to the nearest Flickable). Items inside an invisible subtree (a hidden
tab, a collapsed section) are never collected, so the scan follows what's on
screen. The calendar's month grid is deliberately *not* tagged — it keeps
mouse-only interaction for now.
*** Code
...
Item {
    ...
    property int tick: 0                 // bumped to re-map the ring (scroll/layout)
    ...
    // keep the ring glued through Flickable scrolls / animated layouts
    Timer {
        interval: 250
...
Item {
    ...
    // a presentational one is covered by its row's focus
            ...
            Column {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        // keyboard nav: Enter = the row click (connect / disconnect /
                        // reveal the password field for a secured unknown net)
...
Column {
    ...
    component CycleRow: Item {
        ...
        Rectangle {
            ...
            height: 22
            radius: root.theme.radiusBtn
            color: cycMa.containsMouse ? root.theme.rowHi : root.theme.row
            border.width: 1
    ...
    Column {
        ...
        Flickable {
            ...
            Column {
                ...
                Text {
                    visible: root.tab !== 2 && (root.tab === 0 ? (root.sinks.length + root.sources.length) : root.streams.length) === 0
...
Item {
    ...
    component DevRow: Rectangle {
        ...
        property bool busy: false
        property bool busyTarget: false
        // keyboard nav: Enter = the row click (connect / disconnect / pair)
...
Item {
    ...
    MenuHeader {
        ...
        Rectangle {
            ...
            radius: root.theme.radiusBtn
            anchors.verticalCenter: parent.verticalCenter
            color: finBtnMa.containsMouse ? root.theme.rowHi : "transparent"
            MSym {
                anchors.centerIn: parent
...
Item {
    ...
    MenuHeader {
        ...
        Rectangle {
            ...
            radius: root.theme.radiusBtn
            anchors.verticalCenter: parent.verticalCenter
            color: hdrBookMa.containsMouse ? root.theme.rowHi : root.theme.row
            border.width: 1
        ...
        Rectangle {
            ...
            radius: root.theme.radiusBtn
            anchors.verticalCenter: parent.verticalCenter
            color: hdrCurMa.containsMouse ? root.theme.rowHi : root.theme.row
            border.width: 1
            border.color: root.fin && root.fin.displayCurrency !== "native"
                        ? root.theme.money : "transparent"
            Text {
        ...
        Rectangle {
            ...
            radius: root.theme.radiusBtn
            anchors.verticalCenter: parent.verticalCenter
            color: eyeMa.containsMouse ? root.theme.rowHi : "transparent"
            MSym {
                anchors.centerIn: parent
        ...
        Rectangle {
            ...
            radius: root.theme.radiusBtn
            anchors.verticalCenter: parent.verticalCenter
            color: calBtnMa.containsMouse ? root.theme.rowHi : "transparent"
            MSym {
                anchors.centerIn: parent
                icon: "calendar_month"
                size: 16
...
Item {
    ...
    Column {
        ...
        Grid {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    height: 60
                    radius: root.theme.radiusRow
                    color: on ? root.theme.accentSoft : (tileMa.containsMouse ? root.theme.rowHi : root.theme.row)
                    border.width: 1
        ...
        Row {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    height: 22
                    radius: root.theme.radiusBtn
                    color: on ? root.theme.accent : (catMa.containsMouse ? root.theme.rowHi : root.theme.row)
                    border.width: 1
                    border.color: on ? root.theme.accent : root.theme.border
                    Text {
                        id: catTxt
        ...
        Rectangle {
            ...
            visible: root.sel !== ""
            radius: root.theme.radiusRow
            color: startMa.containsMouse ? root.theme.danger : root.theme.accent
            Behavior on color { ColorAnimation { duration: root.theme.animFast } }
            Row {
                anchors.centerIn: parent
                spacing: 8
