...
Variants {
    ...
    PanelWindow {
                ...
                Launcher {
                    ...
                    onAppMenuRequested: (app, fav, pinned, x, y) => {
                        ...
                        launcherMenu.openFor(app, p.x, p.y,
                            { fav: fav, showFav: true, pinned: pinned, showPin: true });
                    }
            ...
            Item {
                ...
                Loader {
                    ...
                    sourceComponent: AppContextMenu {
                        ...
                        group: win.ctxGroup
                        desktops: root.desktops
                        isPinned: win.ctxGroup
                            ? root.isPinned(win.ctxGroup.entry || DesktopEntries.heuristicLookup(win.ctxGroup.icon))
                            : false
                        onLaunchRequested: (s) => {
                            root.launch(s);
                            win.ctxGroup = null;
        ...
        AppMenu {
            ...
            onPinToggled: (e) => launcherItem.togglePin(e)
            onLaunched: win.launcher = false
        }
