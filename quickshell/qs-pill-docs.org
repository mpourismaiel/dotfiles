...
Variants {
    ...
    PanelWindow {
        ...
        property int menu: 4 // 0 net, 1 vol, 2 bt, 3 batt, 5 clipboard, 4 notif (default pane)
        ...
        Item {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            y: 6
            width: win.showBurst ? (burstLoader.item ? burstLoader.item.implicitWidth : 96) : win.launcher ? win.launcherWidth : win.ctxMode ? 520 : (win.notifMorph ? (morphStack.item ? morphStack.item.implicitWidth : 420) : (win.open ? 520 : (win.dash ? win.hoverWidth : (56 + root.privacyCount * 20 + (notifs.grouped.length > 0 ? 14 : 0)))))
            ...
            Rectangle {
                ...
                // the roving square only appears over app tiles / tray / status
                // icons; the launcher is its own accent-soft button (no default rest).
            ...
            Item {
                ...
                Column {
                    ...
                    // time over date (unchanged style)
                    Column {
                        spacing: 1
            ...
            Item {
                ...
                // open the app launcher — an accent grid glyph that only picks up
                // the accent-soft background on hover (transparent at rest, so it
                // doesn't read as permanently highlighted). It has its own hover
                // feedback and so doesn't share the roving hover square.
                Rectangle {
                    id: launcherIcon
                    ...
                    height: 42
                    radius: 12
                    color: launchMa.containsMouse ? theme.accentSoft : "transparent"
            ...
            Item {
                ...
                Loader {
                    ...
                    anchors.fill: parent
                    active: win.open
                    sourceComponent: win.menu === 0 ? cNet : win.menu === 1 ? cVol : win.menu === 2 ? cBt : win.menu === 3 ? cBatt : win.menu === 5 ? cClip : cNotif
                }
