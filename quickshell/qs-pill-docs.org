...
flagged (an unmuted mic is a routine resting state, so it was more noise than signal).
#+name: init-privacy
#+begin_src qml
    ...
    PanelWindow {
        ...
        Item {
            ...
            PillSurface {
                ...
                Behavior on anchors.leftMargin { NumberAnimation { duration: theme.anim; easing.type: Easing.OutCubic } }
                Behavior on anchors.rightMargin { NumberAnimation { duration: theme.anim; easing.type: Easing.OutCubic } }
            }
