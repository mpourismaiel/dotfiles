            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Row {
                        ...
                        // soft-blue: the day has Google Calendar events
                        Rectangle {
                            visible: root.cal && root.cal.hasEvents(cell.modelData.key)
                            width: 4
                            height: 4
                            radius: 2
    ...
    Item {
        ...
        Flickable {
            ...
            Column {
                ...
                //      description, guests and a Join button). Always shown so the
                //      refetch button (top-right) has a home. ----
                Rectangle {
                    width: agendaCol.width
                    height: 1
                    color: root.theme.divider
                ...
                Text {
                    visible: !!(root.cal && root.cal.lastError) && root.calEvents.length === 0
                    width: agendaCol.width
                    wrapMode: Text.WordWrap
...
QtObject {
    ...
    Component.onCompleted: { checkToday(); loadEntities(); }
...
Rectangle {
    ...
    border.color: critical ? theme.danger : (transcribe ? theme.accentSoft : theme.border)
    implicitWidth: 420
