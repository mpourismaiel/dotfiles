...
Item {
    ...
    // ---- wired (LAN) + VPN via nmcli (neither is in the native Wi-Fi binding) ----
    property var vpns: []
    property var lans: []
    ...
    // a wired/VPN connection row (name + connect/disconnect), reused by both the
    // LAN and VPN sections (they share the nmcli up/down plumbing).
    component ConnRow: Rectangle {
        ...
        Text {
            ...
            anchors.right: st.left; anchors.rightMargin: 8
            anchors.verticalCenter: parent.verticalCenter
        ...
        Text {
            ...
            anchors.verticalCenter: parent.verticalCenter
            text: conn.active ? "Disconnect" : "Connect"
            color: conn.active ? root.theme.accent : root.theme.textDim
        ...
        MouseArea {
            anchors.fill: parent
            cursorShape: Qt.PointingHandCursor
            onClicked: root.setConn(conn.name, !conn.active)
        }
    }
    ...
    Column {
        ...
        Flickable {                             // network list
            ...
            Column {
                ...
                NetLabel { text: "Wired"; visible: root.lans.length > 0 }
                Repeater {
                    model: root.lans
                ...
                // ---- Wi-Fi ----
                NetLabel { text: "Wi-Fi"; visible: root.nets.length > 0 }
                Repeater {
                    model: root.nets
                    delegate: Rectangle {
                        id: netRow
                ...
                NetLabel { text: "VPN"; visible: root.vpns.length > 0 }
                Repeater {
                    model: root.vpns
                    delegate: ConnRow { required property var modelData; width: netCol.width; conn: modelData }
                }
    ...
    Rectangle {
        ...
        Column {
            ...
            Rectangle {
                ...
                border.color: pskInput.activeFocus ? root.theme.accent : root.theme.border
                TextInput {
                    id: pskInput
                    anchors.fill: parent
...
Item {
    ...
    component DevRow: Rectangle {
        ...
        Text {
            ...
            color: device.connected ? root.theme.accent : root.theme.textDim
            font.family: root.theme.mono
            font.pixelSize: root.theme.fsSmall
            font.letterSpacing: root.theme.labelSpacing
            font.capitalization: Font.AllUppercase
        ...
        if m:
            ...
            if not os.path.exists(path):
                ...
                with open(path, "wb") as f:
                    f.write(data)
            result.append({"id": _id(cid), "kind": "image",
            ...
            result.append({"id": _id(cid), "kind": "text",
                           "text": text, "images": n})
...
Row {
    ...
    Repeater {
        model: [
            { ic: "wifi",          fill: 0, menu: 0, warn: false, badge: 0 },
