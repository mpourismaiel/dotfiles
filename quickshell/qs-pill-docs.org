...
Variants {
    ...
    PanelWindow {
        ...
        Item {
            ...
            anchors.horizontalCenter: parent.horizontalCenter
            y: 6
            width: win.showBurst ? (burstLoader.item ? burstLoader.item.implicitWidth : 96) : win.launcher ? win.launcherWidth : win.ctxGroup !== null ? 520 : (win.notifMorph ? (morphStack.item ? morphStack.item.implicitWidth : 420) : (win.open ? 520 : (win.dash ? win.hoverWidth : (56 + root.privacyCount * 20 + (notifs.grouped.length > 0 ? 14 : 0)))))
            height: win.showBurst ? 28 : (win.open || win.launcher) ? win.openHeight : win.ctxGroup !== null ? Math.min(win.openHeight, (ctxLoader.item ? ctxLoader.item.implicitHeight + theme.pad * 2 : 300)) : (win.notifMorph ? morphStack.implicitHeight : (win.dash ? win.hoverHeight : 28))
            ...
            MouseArea {
                anchors.fill: parent
                z: 100
                enabled: win.dash && !win.open && !win.launcher && win.ctxGroup === null && !win.notifMorph
            ...
            MouseArea {
                anchors.fill: parent
                enabled: win.dash && !win.open && !win.launcher && !win.notifMorph && win.ctxGroup === null
                onClicked: {
                    win.launcher = true;
                }
            }
            ...
            Rectangle {
                ...
                color: theme.bgHover
                opacity: (win.dash && !win.open && !win.launcher && !win.notifMorph && win.ctxGroup === null && target) ? 1 : 0
                visible: opacity > 0
                x: pos.x - pad
                y: pos.y - pad
            ...
            Item {
                ...
                height: 36
                opacity: (win.dash && !win.open && !win.launcher && !win.notifMorph && win.ctxGroup === null) ? 1 : 0
                visible: opacity > 0
