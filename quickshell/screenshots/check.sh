...
PILL_STATES=(resting resting-rec resting-due deadlines dashboard menu-network menu-volume menu-bluetooth \
             ...
             menu-finance-wishlist menu-finance-forecast menu-finance-plan menu-tetris menu-blockblast menu-blockblast-combo menu-snake settings settings-productivity menu-done menu-done-loading menu-notifhistory notif-stack \
