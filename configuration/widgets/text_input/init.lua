...
local properties = {
  "unfocus_keys",
  "unfocus_on_root_clicked",
  "unfocus_on_client_clicked",
  "unfocus_on_client_focus",
  "unfocus_on_mouse_leave",
  "unfocus_on_tag_change",
  "focus_on_subject_mouse_enter",
  "unfocus_on_subject_mouse_leave",
  "click_timeout",
  "reset_on_unfocus",
  "text_color",
  "placeholder",
...
function text_input:set_widget_template(widget_template)
  ...
  if placeholder_widget then
    ...
    wp.placeholder_widget = placeholder_widget
  end
  ...
  wp.text_widget:connect_signal(
    "button::press",
    function(_, lx, ly, button, mods, find_widgets_result)
      if gtable.hasitem(mods, "Mod4") or button ~= 1 then
        return
      end

      single_double_triple_tap(
        self,
        {
  ...
  wp.text_widget:connect_signal(
    "mouse::leave",
    function(_, find_widgets_result)
...
function text_input:set_text(text)
  ...
  if wp.placeholder_widget then
    if text == "" then
      wp.placeholder_widget.visible = true
    else
      wp.placeholder_widget.visible = false
    end
  end
end
...
local function new()
  ...
  wp.placeholder = ""
  wp.text_color = theme.fg_primary
  wp.text = ""

  wp.cursor_width = 2
  wp.cursor_bg = theme.fg_primary
  wp.cursor_blink = true
  wp.cursor_blink_rate = 0.6

  wp.selection_bg = theme.bg_focus

  widget:set_widget_template(
    wibox.widget {
