-- Edited from official keyboard layout widget, changed markup and widget format
---------------------------------------------------------------------------
...
local function update_status(self)
  ...
  if #self._layout > 0 then
    ...
    if name then
      text = "<b><span font_size='12pt'>" .. (name == "ir" and "FA" or name == "us" and "EN" or name) .. "</span></b>"
    end
  end
