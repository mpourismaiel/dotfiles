...
**** Sideline
Show lightweight IDE feedback at the right edge of the code window: LSP code
actions and Flycheck diagnostics. This replaces =lsp-ui-sideline= so there is a
single sideline renderer.
