...
export PATH=/usr/local/bin:$BIN_FOLDER:/usr/local/go/bin:$PATH
...
source /home/mahdi/.bin/git-extras//etc/git-extras-completion.zsh

. ~/.bin/z/z.sh
. /etc/bash.command-not-found
. ~/.bin/colored-man-pages.plugin.zsh
