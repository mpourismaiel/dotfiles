...
local function create_corner_top_left(args)
  ...
  cr:arc(radius + radius_offset, radius + radius_offset, radius, math.rad(180), math.rad(270))
  ...
  local function add_stroke(nargs)
    ...
    cr:arc(arc_radius + offset_x, arc_radius + offset_y, arc_radius, math.rad(180), math.rad(270))
