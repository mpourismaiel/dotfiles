...
local apply_borders = function(widget, width, height, radius)
  local args = get_border_colors("#1C1E26")
  ...
  local corner_bottom_left_img =
    ...
    shapes.create_corner_top_left {
      ...
      stroke_source_inner = shapes.gradient(args.stroke_color_inner_bottom, args.stroke_color_inner_sides, radius),
      stroke_width_inner = 1,
      stroke_width_outer = 1
    },
    "vertical"
